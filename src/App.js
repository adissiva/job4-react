...
const getData = () => [
  ...
  { campaigns: "6", status: 'ERROR', views: "19,599", clicks: '6030', conversions: '739', preview: '' },
  { campaigns: "7", status: 'ERROR', views: "19,599", clicks: '6030', conversions: '739', preview: '' },
];
      ...
      <div className="App" style={{ height: "100%" }}>
        <div className="min-h-screen bg-gray-100 text-gray-900">
          <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
            ...
            <div className="mt-4">
              {data.length > 10 ? <RebblyTable columns={columns} data={data} /> : <RebblyTable columns={columns} data={data} />}
            </div>
          </main>
        </div>
      </div>
